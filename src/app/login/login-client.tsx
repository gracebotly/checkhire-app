...
type UserType = "employer" | "job_seeker";
...
export default function AuthShell() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (body?.hasSession) {
        // Auto-confirmed — route immediately
        ...
        <div className="relative hidden w-[42%] flex-col justify-start gap-8 overflow-hidden bg-[#0F1117] p-9 md:flex">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-white">CheckHire</span>
            </div>
          </div>
          ...
          <div className="relative z-10 space-y-2">
            {[
              ...
              "Your identity stays hidden until you choose",
              "45-day listing expiration — no ghost jobs",
            ].map((f) => (
          ...
          {tab === "signup" && (
            <form onSubmit={handleSignUp} className="space-y-3">
              <div>
                ...
                <p className="mt-0.5 text-xs text-slate-500">
                  Join the trust-first job board
                </p>
              </div>
              ...
              <div className="space-y-2">
                <label className="block text-xs font-medium text-gray-600">I want to...</label>
                <div className="flex gap-2">
                  <button
                    type="button"

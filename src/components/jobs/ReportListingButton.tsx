...
const LISTING_REASONS: { value: FlagReason; label: string }[] = [
  { value: "ghost_job", label: "Ghost job — no intent to hire" },
  { value: "bait_and_switch", label: "Bait and switch — role doesn't match description" },
  { value: "predatory_listing", label: "Predatory or misleading listing" },
  { value: "mlm_suspected", label: "Suspected MLM / network marketing" },
  { value: "sensitive_info_request", label: "Requests sensitive personal info" },
  { value: "unresponsive", label: "Employer is unresponsive" },
            ...
            {submitted ? (
              ...
              <>
                ...
                <Dialog.Description className="mt-1 text-sm text-slate-600">
                  Help us keep CheckHire safe. Select a reason for your report.
                </Dialog.Description>

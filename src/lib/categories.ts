...
export const DEAL_CATEGORIES: { value: DealCategory; label: string; description: string }[] = [
  ...
  { value: "marketing", label: "Marketing & Ads", description: "Ads, outreach, campaigns, strategy" },
  { value: "content_creation", label: "Content Creation", description: "Sponsored posts, UGC, brand content, product reviews" },
  { value: "influencer", label: "Influencer & Creator", description: "Influencer partnerships, shoutouts, collabs, promotions" },
  { value: "social_media", label: "Social Media Mgmt", description: "Account management, content calendars, engagement, growth" },
